...
public class extentreport {
	...
	public void setExtent() {
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/mvnproject/test-output//yogesh.html");
		//"C:\\worksoft\\test"
		//Create an instance of the class
		//Where to create the HTML report
		
		//htmlReporter.
		htmlReporter.config().setDocumentTitle("MY REPORT "); // Tile of report - you can change
	...
	public void noCommerceTitleTest() {
		...
		Assert.assertEquals(title, "facebook.com");
	...
	public void noCommerceLogoTest() {
		...
		test.log(Status.INFO, "test.log - INFO  - Checking siginin link");
		Assert.assertTrue(b);
	}
